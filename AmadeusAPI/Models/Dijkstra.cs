...
namespace AmadeusAPI.Models
{
    public class Dijkstra
    {
        ...
        const string graphFilePath = "\\Models\\graph2.txt"; // "./graph2.txt";
        ...
        public void ShortestPath(string startNode , string destNode)
        {
            ...
            //graph.GetAllPath(0, 3);
            //var ggg= graph.AllpathList;
            //Console.ReadLine();
        }
        ...
        {          
            ...
            string apPath = System.Web.Hosting.HostingEnvironment.MapPath("~/Models/graph2.txt");
        ...
        private static void CheckNode(PrioQueue queue, string destinationNode)
        {
            ...
            foreach (var route in routes.FindAll(r => r.From == queue.First.Value.Name))
            {
                ...
                // Console.WriteLine("travelledDistance "+ travelledDistance);
            ...
            // Console.WriteLine("remove : " + queue.First.Value.Name);
